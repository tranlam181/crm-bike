// Angular
import { Component, Input, Output, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, ViewEncapsulation } from '@angular/core'; // tslint:disable-line
// Ionic
...
@Component({
	...
	templateUrl: 'side-menu-content.component.html',
  	// styleUrls: ['./side-menu-content.component.css'],
